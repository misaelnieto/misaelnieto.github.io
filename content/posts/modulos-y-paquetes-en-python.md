...
date: "2014-04-25"
summary: "Qué es un módulo, qué es un paquete, y cómo se manipula el Python Path."
...
tags:
  ...
  - python-path
locale: "es_MX"
keywords: "python, módulos, paquetes, python path, sys.path, namespace, __init__.py"
---
