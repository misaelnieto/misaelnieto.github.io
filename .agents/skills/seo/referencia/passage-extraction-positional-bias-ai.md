## Táctica: Passage-Level Extraction & Positional Bias for AI Citations

**Descripción:**
*   **Passage-Level Extraction:** Los motores de IA y LLMs (ej. Perplexity) tienden a extraer y citar fragmentos específicos (pasajes) de contenido, en lugar de páginas enteras, para responder a consultas.
*   **Positional Bias:** Existe una tendencia notable (especialmente en resultados de IA) a favorecer y citar contenido que aparece prominentemente en la parte superior de la página (primeros ~30% del contenido visible).

**Popularidad:** Alta (Tendencia clave 2025-2026, basada en investigación empírica).
